...
import { BookingsFilter, BookingStatus } from '@/features/bookings/types'
...
export function BookingsFilterBar({ filter, onChange }: BookingsFilterBarProps) {
   ...
   return (
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
         <div className="relative flex-1">
            ...
            <Input
               id="bookings-search"
               placeholder="Search by guest, host, email or property…"
               value={searchInput}
         ...
         <div className="flex items-center gap-2">
            ...
            <Select
               value={filter.status ?? ''}
               onValueChange={(value) =>
                  onChange({ ...filter, status: (value as BookingStatus) || undefined, page: 1 })
               }
            >
               <SelectTrigger
